...
//            Application.MessageLoop
        ...
        )
    {
            ...
            )
        {
            ...
            strAlign = padRight(strAlign, intLong_I, charLeftRight_I);
        }
        else
        {
                                                      		//Completa con caracteres del lado izquierdo.
            strAlign = padLeft(strAlign, intLong_I, charLeftRight_I);
        }
...
//            }
    ...
    //==================================================================================================================
    /*TASK Tools.padRight and Tools.padLeft Pads a string*/
    //------------------------------------------------------------------------------------------------------------------
	public static String padLeft(String strToPad, int intLong, char charRight)
	{
	...
	//------------------------------------------------------------------------------------------------------------------
	public static String padLeft(String strToPad, int intLong)
	{
		for(int intI = strToPad.length(); intI < intLong; intI = intI + 1)
		{
			strToPad = ' ' + strToPad;
	...
	//------------------------------------------------------------------------------------------------------------------
	public static String padRight(String strToPad, int intLong, char charRight)
	{
		for(int intI = strToPad.length(); intI < intLong; intI = intI + 1)
		{
	...
	//------------------------------------------------------------------------------------------------------------------
	public static String padRight(String strToPad, int intLong)
	{
		for(int intI = strToPad.length(); intI < intLong; intI = intI + 1)
		{
			strToPad = strToPad + ' ';
