                                                            ...
                                                            //Algunos de estos proyectos son QEnabler y Sense.
{
    ...
    private static /*readonly*/ T4techInfoTuple[] arrt4techTABLE;
    private static /*readonly*/ T3instInfoTuple[] arrt3instTABLE;
    private static /*readonly*/ T3fextInfoTuple[] arrt3fextTABLE;
    //------------------------------------------------------------------------------------------------------------------
    ...
    )
    {
        if (
            ...
            Tools.subAbort(Tes2.strTo(techtechToSearch_I, "techtechToSearch_I") + " can not be null");
    ...
    )
    {
        ...
        {
            codxxGet = SoftwareAutomationCobol.CodcbCobol.codcbDUMMY_UNIQUE;
        }
        else if (
                techtechToSearch_I == TechtechEnum.OBJECT_ORIENTED
                )
        {
            codxxGet = SoftwareAutomationObjectOriented.CodooObjectOriented.codooDUMMY_UNIQUE;
        }
        else if (
        ...
        {
            Test.subAbort(Test.strTo(techtechToSearch_I, "techtechToSearch_I") +
    ...
    public static T4techInfoTuple t4techGet(String s) {
        return null;
    }
