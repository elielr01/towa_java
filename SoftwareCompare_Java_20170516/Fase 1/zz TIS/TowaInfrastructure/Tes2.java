...
import static TowaInfrastructure.Tools.strPadRight;
    ...
    )
    {
        ...
        for (int intI = 0; intI < arrbclass_I.length; intI = intI + 1)
        {
            String strItem = Tes2.strAnalizeAndFormatBclass(arrbclass_I[intI], TestoptionEnum.FULL);
                                                        ...
                                                        //Format: NL [i]_ item
            arrstrIndexAndItem[intI] = strNL_I + strPadRight(("[" + intI + "]"), intCharsInLongestIndex)
                    + " " + strItem;
        }
    ...
    )
    {
        ...
        for (int intI = 0; intI < arrintValue_I.length; intI = intI + 1)
        {
            ...
            arrstrEntry[intI] = ostrNL.v +
                    strPadRight(("[" + strKey + "]"), intLonghestKey) + " " +
...
//
        ...
        )
    {
        ...
        return System.lineSeparator() + strPadRight("", intSpaces);
    }
