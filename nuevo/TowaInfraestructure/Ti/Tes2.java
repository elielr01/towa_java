...
{
    //==================================================================================================================
    /*TASK Tes2.PrepareStrTo Constants and initializer for strTo*/
    //------------------------------------------------------------------------------------------------------------------
    ...
    private static Oobject<PrintWriter> sysswTestLog;
        ...
        )
    {
        ...
        Tes2.subPrepareConstantsArrt2uccCharUsefulInText(ostrCHAR_USEFUL_IN_TEXT_O, oarrcharUSEFUL_IN_TEXT_O);
        Tes2.strCHAR_USEFUL_IN_TEXT = ostrCHAR_USEFUL_IN_TEXT_O.v;
        Tes2.arrcharUSEFUL_IN_TEXT = oarrcharUSEFUL_IN_TEXT_O.v;

        oarrcharDO_NOT_SHOW_HEX_O.v = oarrcharUSEFUL_IN_TEXT_O.v;

        Tes2.subPrepareConstantsArrt3fakecharFake();
        Tes2.subPrepareConstantsArrt2charNonprintable();
        Tes2.subPrepareConstantsArrt2charEscape();

        Tes2.subPrepareConstantsArrt2charDescription(oarrt2charDESCRIPTION_O);
    }
    ...
    {
        //                                                  //To easy code
        T2uccCategoryAndCharsTuple[] arrt2ucc = Tes2.arrt2uccCHAR_USEFUL_IN_TEXT;
        ...
        for (int intUcc = 1; intUcc < arrt2ucc.length; intUcc = intUcc + 1)
        {
            if (
                ...
                Tes2.subAbort(Tes2.strTo(arrt2ucc[intUcc - 1].ucc, "arrt2ucc[" + (intUcc - 1) + "].ucc") + ", " +
                    Tes2.strTo(arrt2ucc[intUcc].ucc, "arrt2ucc[" + intUcc + "].ucc") +
        ...
        for (int intUcc = 0; intUcc < arrt2ucc.length; intUcc = intUcc + 1)
        {
            ...
            for (int intC = 1; intC < strChars.length(); intC = intC + 1)
            {
                if (
                    ...
                    Tes2.subAbort(Tes2.strTo(strChars, "arrt2ucc[" + intUcc + "].strChars") + ", " +
                        Tes2.strTo(strChars.charAt(intC - 1), "strChars.charAt(" + (intC - 1) + ")") + ", " +
                        Tes2.strTo((int)strChars.charAt(intC - 1), "(int)strChars.charAt(" + (intC - 1) + ")") + ", " +
                        Tes2.strTo(strChars.charAt(intC), "strChars.charAt(" + intC + ")") + ", " +
                        Tes2.strTo((int)strChars.charAt(intC), "(int)strChars.charAt(" + intC + ")") +
                        " should be in ascending order");
            }
        }
    ...
    {
        Arrays.sort(Tes2.arrt3fakecharFAKE);

        //                                                  //Verifica no duplicados
        Tools.subVerifyDuplicate(Tes2.arrt3fakecharFAKE, "Tes2.arrt3fakecharFAKE");

        //                                                  //Verifica chars en tupla
        for (int intT3 = 0; intT3 < Tes2.arrt3fakecharFAKE.length; intT3 = intT3 + 1)
        {
            if (
                Arrays.binarySearch(Tes2.arrcharUSEFUL_IN_TEXT, Tes2.arrt3fakecharFAKE[intT3].charFAKE) < 0
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt3fakecharFAKE[intT3].charFAKE,
                        "Tes2.arrt3fakecharFAKE[" + intT3 + "].charFAKE") +
                        " do not exist in USEFUL_IN_TEXT");

            if (
                Tes2.arrt3fakecharFAKE[intT3].charFAKE != Tes2.arrt3fakecharFAKE[intT3].charHEX
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt3fakecharFAKE[intT3].charFAKE,
                        "Tes2.arrt3fakecharFAKE[" + intT3 + "].charFAKE") +
                        ", " +
                        Tes2.strTo(Tes2.arrt3fakecharFAKE[intT3].charHEX,
                            "Tes2.arrt3fakecharFAKE[" + intT3 + "].charHEX") +
                        " should be equal");

            //                                              //Verifica descripción

            //                                              //To easy code
            String strDESCRIPTION = Tes2.arrt3fakecharFAKE[intT3].strDESCRIPTION;

            if (
                strDESCRIPTION == null
                )
                Tes2.subAbort(
                    Tes2.strTo(strDESCRIPTION, "arrt3fakecharFAKE[" + intT3 + "].strDESCRIPTION") +
                        " can not be null");
                ...
                )
            {
                ...
                if (
                    ...
                    Tes2.subAbort(Tes2.strTo(charFaked, "charFaked") + ", " +
                        Tes2.strTo(strCharFaked, "strCharFaked") + ", " +
                        Tes2.strTo(strDESCRIPTION, "Tes2.arrt3fakecharFAKE[" + intT3 + "].strDESCRIPTION") +
            ...
            {
                Tes2.subAbort(Tes2.strTo(strDESCRIPTION, "arrt3fakecharFAKE[" + intT3 + "].strDESCRIPTION") +
                    " invalid description");
            }
            /*END-CASE*/
        }
    ...
    {
        Arrays.sort(Tes2.arrt2charNONPRINTABLE);

        //                                                  //Verifica no duplicados
        Tools.subVerifyDuplicate(Tes2.arrt2charNONPRINTABLE, "Tes2.arrt2charNONPRINTABLE");
        ...
        for (int intT2 = 0; intT2 < arrt2charNONPRINTABLE.length; intT2 = intT2 + 1)
        {
            ...
            if (
                Arrays.binarySearch(Tes2.arrcharUSEFUL_IN_TEXT, Tes2.arrt2charNONPRINTABLE[intT2].charX) < 0
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt2charNONPRINTABLE[intT2].charX,
                        "Tes2.arrt2charNONPRINTABLE[" + intT2 + "].charX") +
                        " does not exist in USEFUL_IN_TEXT");

            if (
                Tes2.arrt2charNONPRINTABLE[intT2].strDESCRIPTION == null
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt2charNONPRINTABLE[intT2].strDESCRIPTION,
                        "Tes2.arrt2charNONPRINTABLE[" + intT2 + "].strDESCRIPTION") +
                        " can not be null");
    ...
    {
        Arrays.sort(Tes2.arrt2charESCAPE);

        //                                                  //Verifica no duplicados
        Tools.subVerifyDuplicate(Tes2.arrt2charESCAPE, "Tes2.arrt2charESCAPE");

        //                                                  //Verifica chars en tupla
        for (int intT2 = 0; intT2 < arrt2charESCAPE.length; intT2 = intT2 + 1)
        {
            if (
                Arrays.binarySearch(Tes2.arrcharUSEFUL_IN_TEXT, Tes2.arrt2charESCAPE[intT2].charX) >= 0
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt2charESCAPE[intT2].charX, "Tes2.arrt2charESCAPE[" + intT2 + "].charX") +
                        " exists in USEFUL_IN_TEXT");

            if (
                Tes2.arrt2charESCAPE[intT2].strDESCRIPTION == null
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt2charESCAPE[intT2].strDESCRIPTION,
                        "Tes2.arrt2charESCAPE[" + intT2 + "].strDESCRIPTION") +
                        " can not be null");

            if (
                Tes2.arrt2charESCAPE[intT2].strDESCRIPTION.equals("")
                )
                Tes2.subAbort(
                    Tes2.strTo(Tes2.arrt2charESCAPE[intT2].strDESCRIPTION,
                        "Tes2.arrt2charESCAPE[" + intT2 + "].strDESCRIPTION") +
    ...
    {
        oarrt2charDESCRIPTION_O.v = new T2charDescriptionTuple[Tes2.arrt2charNONPRINTABLE.length +
            Tes2.arrt3fakecharFAKE.length + Tes2.arrt2charESCAPE.length];

        System.arraycopy(Tes2.arrt2charNONPRINTABLE, 0, oarrt2charDESCRIPTION_O.v, 0,
            Tes2.arrt2charNONPRINTABLE.length);

        //                                                  //Desplazamiento para mover arrt3
        int intDesp = Tes2.arrt2charNONPRINTABLE.length;

        for (int intT4 = 0; intT4 < Tes2.arrt3fakecharFAKE.length; intT4 = intT4 + 1)
        {
            oarrt2charDESCRIPTION_O.v[intDesp + intT4] = new T2charDescriptionTuple(
                Tes2.arrt3fakecharFAKE[intT4].charFAKE, Tes2.arrt3fakecharFAKE[intT4].strDESCRIPTION);
        }

        System.arraycopy(Tes2.arrt2charESCAPE, 0, oarrt2charDESCRIPTION_O.v,
            Tes2.arrt2charNONPRINTABLE.length + Tes2.arrt3fakecharFAKE.length, Tes2.arrt2charESCAPE.length);
    ...
    //                                                      //      INICIALIZADAS, SE AÑADE LA LLAMADA A OTRO MÉTODO.
    {
        ...
        Tes2.arrcharUSEFUL_IN_TEXT = Tes2.strCHAR_USEFUL_IN_TEXT.toCharArray();
        Arrays.sort(Tes2.arrcharUSEFUL_IN_TEXT);
        Tes2.arrcharDO_NOT_SHOW_HEX = Tes2.arrcharUSEFUL_IN_TEXT;
        Tes2.arrt2charDESCRIPTION = new T2charDescriptionTuple[] { };
        
        //                                                  //Reference passing for subPrepareConstantsForStrTo
        Ostring ostrCHAR_USEFUL_IN_TEXT = new Ostring(Tes2.strCHAR_USEFUL_IN_TEXT);
        Oobject<char[]> oarrcharUSEFUL_IN_TEXT = new Oobject<char[]>(Tes2.arrcharUSEFUL_IN_TEXT);
        Oobject<char[]> oarrcharDO_NOT_SHOW_HEX = new Oobject<char[]>(Tes2.arrcharDO_NOT_SHOW_HEX);
        Oobject<T2charDescriptionTuple[]> oarrt2charDESCRIPTION =
            new Oobject<T2charDescriptionTuple[]>(Tes2.arrt2charDESCRIPTION);
        Tes2.subPrepareConstantsForStrTo(ostrCHAR_USEFUL_IN_TEXT, oarrcharUSEFUL_IN_TEXT, oarrcharDO_NOT_SHOW_HEX,
            oarrt2charDESCRIPTION);
        //                                                  //Put the values in the corresponding static variables.
        Tes2.strCHAR_USEFUL_IN_TEXT = ostrCHAR_USEFUL_IN_TEXT.v;
        Tes2.arrcharUSEFUL_IN_TEXT = oarrcharUSEFUL_IN_TEXT.v;
        Tes2.arrcharDO_NOT_SHOW_HEX = oarrcharDO_NOT_SHOW_HEX.v;
        Tes2.arrt2charDESCRIPTION = oarrt2charDESCRIPTION.v;
        ...
        )
    {
        ...
        for (int intI = 1; intI < arrstrPRIMITIVE_TYPE_O.v.length; intI = intI + 1)
        {
            if (
                ...
                Tes2.subAbort(Tes2.strTo(arrstrPRIMITIVE_TYPE_O, "arrstrPRIMITIVE_TYPE_O") + ", " +
        ...
        for (int intI = 1; intI < arrstrSYSTEM_TYPE_O.v.length; intI = intI + 1)
        {
            if (
                ...
                Tes2.subAbort(Tes2.strTo(arrstrSYSTEM_TYPE_O, "arrstrSYSTEM_TYPE_O") + ", " +
                    Tes2.strTo(arrstrSYSTEM_TYPE_O.v[intI], "arrstrSYSTEM_TYPE_O[" + intI + "]") + " is duplicated");
        }
        ...
        for (int intI = 1; intI < arrstrGENERIC_TYPE_O.v.length; intI = intI + 1)
        {
            if (
                ...
                Tes2.subAbort(Tes2.strTo(arrstrGENERIC_TYPE_O, "arrstrGENERIC_TYPE_O") + ", " +
                    Tes2.strTo(arrstrGENERIC_TYPE_O.v[intI], "arrstrGENERIC_TYPE_O[" + intI + "]") + " is duplicated");
        }
        ...
        for (int intI = 1; intI < arrstrBOXING_TYPE_O.v.length; intI = intI + 1)
        {
            if (
                ...
                Tes2.subAbort(Tes2.strTo(arrstrBOXING_TYPE_O, "arrstrBOXING_TYPE_O") + ", " +
                    Tes2.strTo(arrstrBOXING_TYPE_O.v[intI], "arrstrBOXING_TYPE_O[" + intI + "]") + " is duplicated");
        }
    }
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(strNameTester_I, "strNameTester_I") + " should have a value");
        if (
            strPathLog_I == null
            )
            Tes2.subAbort(Tes2.strTo(strPathLog_I, "strPathLog_I") + " should have a value");
        /*
        if (
            !strPathLog_I.endsWith(".log")
            )
            Tes2.subAbort(Tes2.strTo(strPathLog_I, "strPathLog_I") + " should have File Extension .log");
        */
    ...
    */
        ...
        )
    {
            ...
            )
        {
            ...
            ostrbclassFull.v = ostrbclassFull.v + ostrNL.v +
                Tes2.strAnalizeAndFormatBclass(bclass_I, StrtoEnum.FULL);

            Tes2.subBlockEnd(ostrNL, ostrbclassFull, ostrLabel.v);
        }
        else
        {
            ostrbclassFull.v = strText_I + "(" + Tes2.strAnalizeAndFormatBclass(bclass_I, StrtoEnum.FULL) + ")";
        }
        ...
        )
    {
        if (
            ...
            Tes2.subAbort("enum_I cannot be null" );
    ...
    {
        return Tes2.strToSupportOneArgumentGeneric(arrbclass_I, StrtoEnum.FULL, strText_I);
    }
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strListItems(
        ...
        )
    {
        ...
        {
            String strItem = Tes2.strAnalizeAndFormatBclass(arrbclass_I[intI], StrtoEnum.FULL);

            //                                              //Format: NL [i]_ item
            arrstrIndexAndItem[intI] = strNL_I + Tools.strPadRight(("[" + intI + "]"), intCharsInLongestIndex)
                + " " + strItem;
        }
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(strText_I, "strText_I") + " should have a value");

        return Tes2.strToSupportDic(arrintValue_I, arrstrKey_I, StrtoEnum.FULL, strText_I, objDicobj_I);
    }
    ...
    //------------------------------------------------------------------------------------------------------------------
    private static String strFormatDicMain(
        //                                                  //Format for display
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strFormatDic(
        //                                                  //Format for display.
        ...
        )
    {
        ...
        for (int intI = 0; intI < arrintValue_I.length; intI = intI + 1)
        {
            ...
            arrstrEntry[intI] = ostrNL.v +
                Tools.strPadRight(("[" + strKey + "]"), intLonghestKey) + " " +
    ...
    {
        return strText_I + "(" + Tes2.strAnalizeAndFormatClass(class_I, StrtoEnum.FULL) + ")";
    }
        ...
        )
    {
        ...
        {
            String strItem = Tes2.strAnalizeAndFormatBtuple(arrbtuple_I[intI], StrtoEnum.FULL);
            boolSetOfLinesItems = (
                strItem.length() > Tes2.intLONG_ITEM_ROW_MATRIX
            );
        ...
        )
    {
        ...
        {
            String strItem = Tes2.strAnalizeAndFormatClass(arrtype_I[intI], StrtoEnum.FULL);
            boolSetOfLinesItems = (
                    strItem.length() > Tes2.intLONG_ITEM_ROW_MATRIX
            );
    ...
    //------------------------------------------------------------------------------------------------------------------
    private static String strLineRow(
        //                                                  //For array of integers.
        //                                                  //Produces:
        //                                                  //{ item, ..., item }.
        ...
        )
    {
        ...
        for (int intI = 0; intI < arrbtuple_I.length; intI = intI + 1)
        {
            arrstrItem[intI] = Tes2.strAnalizeAndFormatBtuple(arrbtuple_I[intI], StrtoEnum.FULL);
        }
        ...
        )
    {
        ...
        for (int intI = 0; intI < arrbtuple_I.length; intI = intI + 1)
        {
            arrstrItem[intI] = Tes2.strAnalizeAndFormatClass(arrbtuple_I[intI], StrtoEnum.FULL);
        }
...
//                Tes2.subAbort(Tes2.strTo(obj_I.GetType(), "obj_I.GetType") + " SOMETHING IS WRONG!!!," +
//                    " method strAnalizeAndFormatXxxx to process this system type is missing");
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(testoptionSHORT_I, "testoptionSHORT_I") + " should be SHORT");
        ...
        )
    {
        ...
        else
        {
            ...
            //Tes2.strFormatArrOrOneArgumentGeneric(arrobj_I, testoptionOption_I,
        ...
        )
    {
        ...
        if (
            //                                              //Es USEFUL_IN_TEXT
            Arrays.binarySearch(Tes2.arrcharUSEFUL_IN_TEXT, char_I) >= 0
            )
        {
        ...
        if (
            ...
            (Arrays.binarySearch(Tes2.arrcharDO_NOT_SHOW_HEX, char_I) < 0) ||
                //                                          //De solicita mostar su descripción
                (Arrays.binarySearch(Tes2.arrt2charDESCRIPTION, char_I) >= 0)
            )
        {
                ...
                )
            {
                ...
                int intT2 = Arrays.binarySearch(Tes2.arrt2charDESCRIPTION, char_I);
                strAnalizeAndFormatChar = strAnalizeAndFormatChar + ", " +
                    Tes2.arrt2charDESCRIPTION[intT2].strDESCRIPTION + ">";
            }
            else
            {
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strAnalizeAndFormatStr(
        //                                                  //Prepara un String para su despliege con información de
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strAnalizeAndFormatEnum(
        //                                                  //Analize and format enum (or subclass of enum).
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strAnalizeAndFormatSysexcep(
        //                                                  //Prepare a object to display.
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strAnalizeAndFormatClass(
        //                                                  //Prepare a object to display.
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static String strAnalizeAndFormatBtuple(
        //                                                  //Analize and format btuple (or subclass of btuple).
...
//
    //------------------------------------------------------------------------------------------------------------------
    private static void subBlockStart(
        //                                                  //Genera los parámetros requerido para subToBlockFormat.
    ...
    //------------------------------------------------------------------------------------------------------------------
    private static void subBlockEnd(
    ...
    )
    {
        ...
        if (
            ...
            Tes2.subAbort(Tes2.strTo(Tes2.intLevel, "Tes2.intNivel") + " should be 0 or positive");
    ...
    //------------------------------------------------------------------------------------------------------------------
    public static void subSetHashCode(
        //                                                  //Marca que desea incluir el HashCode en los ObjIn.
        )
    {
        Tes2.boolIsHashCodeOn = true;
    }
    ...
    //------------------------------------------------------------------------------------------------------------------
    public static void subResetHashCode(
        //                                                  //Marca que desea NO incluir el HashCode en los ObjIn.
        )
    {
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(obj_I, "obj_I") + " should have a value");

        if (
            !Tes2.boolIsStandard(obj_I, false)
            )
            Tes2.subAbort(Tes2.strTo(obj_I.getClass(), "obj_I.GetType") + " is nonstandard type");
    ...
    //------------------------------------------------------------------------------------------------------------------
    private static boolean boolIsStandard(
        //                                                  //Evaluate if object has a standard type.
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(obj_I, "obj_I") + " can not be null");
    ...
    private static boolean boolIsStandardSingle(
        //                                                  //Evaluate if type is standard single type.
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(class_I, "type_I") + " can not be null");
        ...
        else
        {
            ...
            if (
                ...
                Tes2.subAbort(Tes2.strTo(Tes2.arrstrPRIMITIVE_TYPE, "arrstrPRIMITIVE_TYPE") + ", " +
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static boolean boolIsStandardPrimitive(
        //                                                  //Evaluate if type is standard primitive type.
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static boolean boolIsStandardSystem(
        //                                                  //Evaluate if type is standard system type.
        ...
        )
    {
        ...
        if (
            ...
            Tes2.subAbort(Tes2.strTo(Tes2.arrstrSYSTEM_TYPE, "Test.arrstrSYSTEM_TYPE") + ", " +
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static boolean boolIsStandardBclass(
        //                                                  //Evaluate if type is standard Bclass.
        ...
        )
    {
        ...
        if (
            ...
            Tes2.subAbort(Tes2.strTo(class_I, "type_I") + " is not an standard bclass type");
            ...
            )
        {
                ...
                )
            {
                ...
                if (
                    ...
                    Tes2.subAbort(Tes2.strTo(class_I, "type_I") +
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static boolean boolIsStandardBtuple(
        //                                                  //Evaluate if type is standard Btuple.
        ...
        )
    {
        ...
        boolean boolIsStandardBtuple = (
            ...
            //                                      //      before "Tuple".
            class_I.getSimpleName().endsWith("Tuple") && (class_I.getSimpleName().length() >=
                ("Tuple".length() + 3)) &&
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private static boolean boolIsStandardEnum(
        //                                                  //Evaluate if type is standard enum type.
        ...
        )
    {
        ...
        if (
            ...
            Tes2.subAbort(Tes2.strTo(class_I, "type_I") + " is not an standard Exception type");
        ...
        )
    {
        ...
        if (
            ...
            Tes2.subAbort(Tes2.strTo(class_I, "type_I") + " is not an standard array type");
        ...
        )
    {
        ...
        if (
            ...
            Tes2.subAbort(Tes2.strTo(classObj, "type_I") + " is not an standard generic Class");
                ...
                )
            {
                    ...
                    )
                {
                    ...
                    if (
                        ...
                        Tes2.subAbort(Tes2.strTo(obj_I, "type_I") + ", " +
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!(
                            ...
                            Tes2.subAbort(Tes2.strTo(classObj, "classObj") +
        ...
        )
    {
            ...
            )
        {
            ...
            {
                Tes2.subAbort(Tes2.strTo(obj_I, "obj_I") + " is not a standard multidimensional array. It's not in" +
                    " format [],[,] or [,,].");
            }
            ...
            )
        {
            ...
            else
            {
                if (
                    ...
                    Tes2.subAbort(Tes2.strTo(obj_I.getClass(), "obj_I.getClass()") +
        ...
        )
    {
        ...
        else
        {
            ...
            if (
                ...
                Tes2.subAbort(Tes2.strTo(Tes2.arrstrPRIMITIVE_TYPE, "Tes2.arrstrPRIMITIVE_TYPE") + ", " +
        ...
        )
    {
        ...
        else
        {
            ...
            if (
                ...
                Tes2.subAbort(Tes2.strTo(Tes2.arrstrPRIMITIVE_TYPE, "Test.arrstrPRIMITIVE_TYPE") + ", " +
...
//                )
//                Tes2.subWarning(Tes2.strTo(Tes2.arrstrPRIMITIVE_TYPE, "Tes2.arrstrPRIMITIVE_TYPE") + ", " +
//                    Tes2.strTo(typeObj, "obj_I.GetType") +
...
//                )
//                Tes2.subWarning(Tes2.strTo(Tes2.arrstrSYSTEM_TYPE, "Tes2.arrstrSYSTEM_TYPE") + ", " +
//                    Tes2.strTo(typeObj, "obj_I.GetType") +
//                    " SOMETHING IS WRONG!!! a branch in previous case is missing, you may continue");
...
//                    " SOMETHING IS WRONG!!! a branch in previous case is missing, you may continue");
            ...
            )
        {
            ...
            else
            {
                    ...
                    )
                {
                    ...
                    bclass_I.strTo(StrtoEnum.SHORT);
                    System.out.println(strAnalizeAndFormatBclass);
                }
                else
                {
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(class_I, "class_I") + " can not be null.");

        if (!(
            BboxBaseBoxingAbstract.class.isAssignableFrom(class_I)
        ))
            Tes2.subAbort(Tes2.strTo(class_I, "class_I") + " is not a BboxBaseBox. Only boxing classes are allowed.");
        ...
        {
            Tes2.subAbort(Tes2.strTo(class_I, "class_I") +
                " SOMETHING is WRONG!!! a branch in previous case is missing");
        ...
        )
    {
        ...
        {
            Tes2.subAbort(Tes2.strTo(class_I, "class_I") + " should not be null.");
            classOfArray = null;
        }
        if (!(
            class_I.isArray()
        ...
        {
            Tes2.subAbort(Tes2.strTo(class_I, "class_I") + " is not the class of an array.");
            classOfArray = null;
        }
        /*CASE*/
        if (
        ...
        )
    {
        ...
        {
            Tes2.subAbort(Tes2.strTo(obj_I.getClass(), "obj_I.getClass()") + " is not the class of an array.");
            boolMultiDimensionArrayIsStandard = false;
        }
        else
        {
            ...
            {
                Tes2.subAbort(Tes2.strTo(obj_I, "obj_I") +
                    " is an array but is not of rank 1,2 or 3. It is not [], [,], or [,,]");
                boolMultiDimensionArrayIsStandard = false;
            }
            /*END-CASE*/
        ...
        )
    {
        ...
        {
            //                                              //The length of each array should be the same as the first.
            intLength = arr2bool[0].length;
            int intI = 1;
            /*UNTIL-DO*/
            while (!(
                (intI >= arr2bool.length) ||
                    (arr2bool[intI] == null) ||
                    //                                          //The inner array is of different size than the others.
                    (arr2bool[intI].length != intLength)
            ))
            {
                intI = intI + 1;
            }
            ...
            //                                              //All inner arrays were of the same size ([l,m])
            boolArr2DIsStandard = intI >= arr2bool.length;
        }
        /*END-CASE*/
        ...
        )
    {
        ...
        if (
            ...
            Tes2.sysswTestLog != null
            )
        {
            Sys.subWriteLine(strInfoToLog_I, Tes2.sysswTestLog);
        }
    }
        ...
        )
    {
        if (
            ...
            Tes2.subAbort(Tes2.strTo(sysswLogTrace, "sysswLogTrace") + " should be created and asigned");
    ...
    //==================================================================================================================
    /*TASK Tes2.subAbort subAbort and subWarnint*/
    //------------------------------------------------------------------------------------------------------------------
