...
//                )
//                Tes3.subAbort(Test.strTo(arrcharKEYBOARD, "arrcharKEYBOARD") + ", " +
...
//                )
//                Tes3.subAbort(Test.strTo(arrcharNONVISIBLE, "arrcharNONVISIBLE") + ", " +
...
//                )
//                Tes3.subAbort(Test.strTo(strCHAR_KEYBOARD.charAt(intI), "strCHAR_KEYBOARD[" + intI + "]") +
...
//                )
//                Tes3.subAbort(Test.strTo(arrcharNONVISIBLE_O[intI], "arrcharNONVISIBLE_O[" + intI + "]") +
...
//            )
//            Tes3.subAbort(Test.strTo(testoptionSHORT_I, "testoptionSHORT_I") + " should be SHORT");
//
...
//            strText_I == null
//            )
//            Tes3.subAbort(Test.strTo(strText_I, "strText_I") + " should have a value");
//
...
//            )
//            Tes3.subAbort(Test.strTo(typeObj, "obj_I.GetType") + " is not an standard type");
//
...
//                )
//                Tes3.subAbort(Test.strTo(typeObj, "obj_I.GetType") +
...
//            ))
//            Tes3.subAbort(Test.strTo(typeOneArgumentGeneric, "objOneArgumentGeneric_I.GetType") +
...
//            arrobj_I == null
//            )
//            Tes3.subAbort(Test.strTo(arrobj_I, "arrobj_I") + " should have a value");
//
...
//            ))
//            Tes3.subAbort(Test.strTo(typeElement, "arrobj_I.GetType.GetElementType") + ", " +
...
//            )
//            Tes3.subAbort(Test.strTo(typeDicobj, "objDicobj_I.GetType") + " should be dictionary");
//
...
//                typeArgument == typeof(Exception) || typeArgument.IsSubclassOf(typeof(Exception))
//            ))
//            Tes3.subAbort(Test.strTo(typeDicobj, "typeDicobj.GetType") +
//                " should be dictionary type containing bclass, btuple or enum");
//
//        if (
//            arrstrKey_I == null
//            )
//            Tes3.subAbort(Test.strTo(arrstrKey_I, "arrstrKey_I") + " should have a value");
//
//        if (
//            arrobjValue_I == null
//            )
//            Tes3.subAbort(Test.strTo(arrobjValue_I, "arrobjValue_I") + " should have a value");
//
...
//            ))
//            Tes3.subAbort(Test.strTo(arrobjValue_I.GetType(), "arrobjValue_I.GetType") + ", " +
//                Test.strTo(typeDicobj, "objDicobj_I.GetType") + " array and dictionary are not compatible");
//
//        if (
//            arrstrKey_I.Length != arrobjValue_I.Length
//            )
//            Tes3.subAbort(Test.strTo(Tes3.strGetObjId(arrstrKey_I), "arrstrKey_I.strGetObjId") + ", " +
//                Test.strTo(Tes3.strGetObjId(arrobjValue_I), "arrobjValue_I.strGetObjId") +
...
//            )
//            Tes3.subAbort(Test.strTo(typeKvpobj, "objKvpobj_I.GetType") + " should be KeyValuePair");
//
...
//                typeArgument == typeof(Exception) || typeArgument.IsSubclassOf(typeof(Exception))
//            ))
//            Tes3.subAbort(Test.strTo(typeKvpobj, "typeKvpobj.GetType") +
//                " should be dictionary type containing bclass, btuple or enum");
//
//                                                        	//Value could be null.
//        if (
...
//                ))
//                Tes3.subAbort(Test.strTo(typeValue, "objValue_I.GetType") + ", " +
...
//            class_I == null
//            )
//            Tes3.subAbort(Test.strTo(class_I, "class_I") + " can not be null");
//
...
//                boolAbort_I
//                )
//                Tes3.subAbort(Test.strTo(Test.arrstrPRIMITIVE_TYPE, "arrstrPRIMITIVE_TYPE") + ", " +
...
//            )
//            Tes3.subAbort(Test.strTo(Test.arrstrSYSTEM_TYPE, "Test.arrstrSYSTEM_TYPE") + ", " +
...
//            )
//            Tes3.subAbort(Test.strTo(class_I, "class_I") + " is not an standard bclass type");
//
//        if (
...
//                    boolAbort_I && !boolIsStandardBclass
//                    )
//                    Tes3.subAbort(Test.strTo(class_I, "class_I") +
...
//            )
//            Tes3.subAbort(Test.strTo(class_I, "class_I") + " is not an standard Exception type");
//
...
//    			type_I == null
//                )
//                Tes3.subAbort(Test.strTo(type_I, "type_I") + " can not be null");
...
//            )
//            Tes3.subAbort(Test.strTo(class_I, "class_I") + " is not an standard generic type");
//
//        if (
...
//                    )
//                    Tes3.subAbort(Test.strTo(classObj, "obj_I.GetType") +
...
//                true
//                )
//                Tes3.subAbort(Test.strTo(classObj, "obj_I.GetType") + Test.strTo(classContent, "classContent") +
...
//                true
//                )
//                Tes3.subAbort(Test.strTo(Tools.getClass(obj_I), "obj_I.GetType") + " SOMETHING IS WRONG!!!," +
...
//                true
//                )
//                Tes3.subAbort(Test.strTo(obj_I.GetType(), "obj_I.GetType") +
